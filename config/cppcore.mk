...
CPPCORE_SRC_DIRS   += $(CPPCORE_ARCH_DIR)/$(CPPCORE_ARCH)/$(CPPCORE_SUBARCH)
CPPCORE_SRC_DIRS   += $(wildcard $(CPPCORE_DRIVERS_DIR)/*/*)
...
CPPCORE_INCLUDE    += -I $(CPPCORE_ARCH_DIR)/$(CPPCORE_ARCH)/$(CPPCORE_SUBARCH)/include
