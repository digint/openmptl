...
struct PeripheralMemoryMap
{
  static constexpr reg_addr_t PERIPH_BB_BASE        = 0x42000000; /**< Peripheral base address in the alias region   */
  static constexpr reg_addr_t SRAM_BB_BASE          = 0x22000000; /**< SRAM base address in the alias region         */

  static constexpr reg_addr_t SRAM_BASE             = 0x20000000; /**< SRAM base address in the bit-band region         */
  static constexpr reg_addr_t PERIPH_BASE           = 0x40000000; /**< Peripheral base address in the bit-band region   */

  static constexpr reg_addr_t FSMC_R_BASE           = 0xA0000000; /**< FSMC registers base address   */


  static constexpr reg_addr_t APB1PERIPH_BASE       = PERIPH_BASE;
  static constexpr reg_addr_t APB2PERIPH_BASE       = PERIPH_BASE + 0x10000;
  static constexpr reg_addr_t AHBPERIPH_BASE        = PERIPH_BASE + 0x20000;

  static constexpr reg_addr_t TIM2_BASE             = APB1PERIPH_BASE + 0x0000;
  static constexpr reg_addr_t TIM3_BASE             = APB1PERIPH_BASE + 0x0400;
  static constexpr reg_addr_t TIM4_BASE             = APB1PERIPH_BASE + 0x0800;
  static constexpr reg_addr_t TIM5_BASE             = APB1PERIPH_BASE + 0x0C00;
  static constexpr reg_addr_t TIM6_BASE             = APB1PERIPH_BASE + 0x1000;
  static constexpr reg_addr_t TIM7_BASE             = APB1PERIPH_BASE + 0x1400;
  static constexpr reg_addr_t TIM12_BASE            = APB1PERIPH_BASE + 0x1800;
  static constexpr reg_addr_t TIM13_BASE            = APB1PERIPH_BASE + 0x1C00;
  static constexpr reg_addr_t TIM14_BASE            = APB1PERIPH_BASE + 0x2000;
  static constexpr reg_addr_t RTC_BASE              = APB1PERIPH_BASE + 0x2800;
  static constexpr reg_addr_t WWDG_BASE             = APB1PERIPH_BASE + 0x2C00;
  static constexpr reg_addr_t IWDG_BASE             = APB1PERIPH_BASE + 0x3000;
  static constexpr reg_addr_t SPI2_BASE             = APB1PERIPH_BASE + 0x3800;
  static constexpr reg_addr_t SPI3_BASE             = APB1PERIPH_BASE + 0x3C00;
  static constexpr reg_addr_t USART2_BASE           = APB1PERIPH_BASE + 0x4400;
  static constexpr reg_addr_t USART3_BASE           = APB1PERIPH_BASE + 0x4800;
  static constexpr reg_addr_t UART4_BASE            = APB1PERIPH_BASE + 0x4C00;
  static constexpr reg_addr_t UART5_BASE            = APB1PERIPH_BASE + 0x5000;
  static constexpr reg_addr_t I2C1_BASE             = APB1PERIPH_BASE + 0x5400;
  static constexpr reg_addr_t I2C2_BASE             = APB1PERIPH_BASE + 0x5800;
  static constexpr reg_addr_t CAN1_BASE             = APB1PERIPH_BASE + 0x6400;
  static constexpr reg_addr_t CAN2_BASE             = APB1PERIPH_BASE + 0x6800;
  static constexpr reg_addr_t BKP_BASE              = APB1PERIPH_BASE + 0x6C00;
  static constexpr reg_addr_t PWR_BASE              = APB1PERIPH_BASE + 0x7000;
  static constexpr reg_addr_t DAC_BASE              = APB1PERIPH_BASE + 0x7400;
  static constexpr reg_addr_t CEC_BASE              = APB1PERIPH_BASE + 0x7800;

  static constexpr reg_addr_t AFIO_BASE             = APB2PERIPH_BASE + 0x0000;
  static constexpr reg_addr_t EXTI_BASE             = APB2PERIPH_BASE + 0x0400;
  static constexpr reg_addr_t GPIOA_BASE            = APB2PERIPH_BASE + 0x0800;
  static constexpr reg_addr_t GPIOB_BASE            = APB2PERIPH_BASE + 0x0C00;
  static constexpr reg_addr_t GPIOC_BASE            = APB2PERIPH_BASE + 0x1000;
  static constexpr reg_addr_t GPIOD_BASE            = APB2PERIPH_BASE + 0x1400;
  static constexpr reg_addr_t GPIOE_BASE            = APB2PERIPH_BASE + 0x1800;
  static constexpr reg_addr_t GPIOF_BASE            = APB2PERIPH_BASE + 0x1C00;
  static constexpr reg_addr_t GPIOG_BASE            = APB2PERIPH_BASE + 0x2000;
  static constexpr reg_addr_t ADC1_BASE             = APB2PERIPH_BASE + 0x2400;
  static constexpr reg_addr_t ADC2_BASE             = APB2PERIPH_BASE + 0x2800;
  static constexpr reg_addr_t TIM1_BASE             = APB2PERIPH_BASE + 0x2C00;
  static constexpr reg_addr_t SPI1_BASE             = APB2PERIPH_BASE + 0x3000;
  static constexpr reg_addr_t TIM8_BASE             = APB2PERIPH_BASE + 0x3400;
  static constexpr reg_addr_t USART1_BASE           = APB2PERIPH_BASE + 0x3800;
  static constexpr reg_addr_t ADC3_BASE             = APB2PERIPH_BASE + 0x3C00;
  static constexpr reg_addr_t TIM15_BASE            = APB2PERIPH_BASE + 0x4000;
  static constexpr reg_addr_t TIM16_BASE            = APB2PERIPH_BASE + 0x4400;
  static constexpr reg_addr_t TIM17_BASE            = APB2PERIPH_BASE + 0x4800;
  static constexpr reg_addr_t TIM9_BASE             = APB2PERIPH_BASE + 0x4C00;
  static constexpr reg_addr_t TIM10_BASE            = APB2PERIPH_BASE + 0x5000;
  static constexpr reg_addr_t TIM11_BASE            = APB2PERIPH_BASE + 0x5400;

  static constexpr reg_addr_t SDIO_BASE             = PERIPH_BASE + 0x18000;

  static constexpr reg_addr_t DMA1_BASE             = AHBPERIPH_BASE + 0x0000;
  static constexpr reg_addr_t DMA1_Channel1_BASE    = AHBPERIPH_BASE + 0x0008;
  static constexpr reg_addr_t DMA1_Channel2_BASE    = AHBPERIPH_BASE + 0x001C;
  static constexpr reg_addr_t DMA1_Channel3_BASE    = AHBPERIPH_BASE + 0x0030;
  static constexpr reg_addr_t DMA1_Channel4_BASE    = AHBPERIPH_BASE + 0x0044;
  static constexpr reg_addr_t DMA1_Channel5_BASE    = AHBPERIPH_BASE + 0x0058;
  static constexpr reg_addr_t DMA1_Channel6_BASE    = AHBPERIPH_BASE + 0x006C;
  static constexpr reg_addr_t DMA1_Channel7_BASE    = AHBPERIPH_BASE + 0x0080;
  static constexpr reg_addr_t DMA2_BASE             = AHBPERIPH_BASE + 0x0400;
  static constexpr reg_addr_t DMA2_Channel1_BASE    = AHBPERIPH_BASE + 0x0408;
  static constexpr reg_addr_t DMA2_Channel2_BASE    = AHBPERIPH_BASE + 0x041C;
  static constexpr reg_addr_t DMA2_Channel3_BASE    = AHBPERIPH_BASE + 0x0430;
  static constexpr reg_addr_t DMA2_Channel4_BASE    = AHBPERIPH_BASE + 0x0444;
  static constexpr reg_addr_t DMA2_Channel5_BASE    = AHBPERIPH_BASE + 0x0458;
  static constexpr reg_addr_t RCC_BASE              = AHBPERIPH_BASE + 0x1000;
  static constexpr reg_addr_t CRC_BASE              = AHBPERIPH_BASE + 0x3000;

  static constexpr reg_addr_t FLASH_BASE            = AHBPERIPH_BASE + 0x2000; /**< Flash registers base address      */
  static constexpr reg_addr_t OB_BASE               = 0x1FFFF800;              /**< Flash Option Bytes base address   */

  static constexpr reg_addr_t ETH_BASE              = AHBPERIPH_BASE + 0x8000;
  static constexpr reg_addr_t ETH_MAC_BASE          = ETH_BASE;
  static constexpr reg_addr_t ETH_MMC_BASE          = ETH_BASE + 0x0100;
  static constexpr reg_addr_t ETH_PTP_BASE          = ETH_BASE + 0x0700;
  static constexpr reg_addr_t ETH_DMA_BASE          = ETH_BASE + 0x1000;

  static constexpr reg_addr_t FSMC_Bank1_R_BASE     = FSMC_R_BASE + 0x0000; /**< FSMC Bank1 registers base address    */
  static constexpr reg_addr_t FSMC_Bank1E_R_BASE    = FSMC_R_BASE + 0x0104; /**< FSMC Bank1E registers base address   */
  static constexpr reg_addr_t FSMC_Bank2_R_BASE     = FSMC_R_BASE + 0x0060; /**< FSMC Bank2 registers base address    */
  static constexpr reg_addr_t FSMC_Bank3_R_BASE     = FSMC_R_BASE + 0x0080; /**< FSMC Bank3 registers base address    */
  static constexpr reg_addr_t FSMC_Bank4_R_BASE     = FSMC_R_BASE + 0x00A0; /**< FSMC Bank4 registers base address    */

  static constexpr reg_addr_t DBGMCU_BASE           = 0xE0042000; /**< Debug MCU registers base address   */
};
...
public:
  ...
  struct NVIC
  {
    ...
    template<std::size_t index>
    struct ISER
    : Register<uint32_t, 0xE000E100 + 4 * index, access::rw >
    { static_assert(index < 8, "invalid index for register"); };

    /** Interrupt Set-Enable Registers */
    template<std::size_t index>
    struct ICER : Register<uint32_t, 0xE000E180 + 4 * index, access::rw >
    { static_assert(index < 8, "invalid index for register"); };

    /** Interrupt Set-Pending Registers */
    template<std::size_t index>
    struct ISPR : Register<uint32_t, 0xE000E200 + 4 * index, access::rw >
    { static_assert(index < 8, "invalid index for register"); };

    /** Interrupt Clear-Pending Registers */
    template<std::size_t index>
    struct ICPR : Register<uint32_t, 0xE000E280 + 4 * index, access::rw >
    { static_assert(index < 8, "invalid index for register"); };

    /** Interrupt Active Bit Register */
    template<std::size_t index>
    struct IABR : Register<uint32_t, 0xE000E300 + 4 * index, access::ro >
    { static_assert(index < 8, "invalid index for register"); };
